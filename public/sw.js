...
const PRECACHE = [
  ...
  "/js/components/glossario-modal.js?v=8",
  ...
  "/js/pages/transferencia-page.js?v=16",
  "/js/pages/transferencia-mount.js?v=7",
  "/js/pages/reverse-calc-page.js?v=23",
  "/js/pages/inversa-mount.js?v=8",
  "/js/pages/comparacao-page.js?v=7",
  ...
  "/js/pages/stress-euribor-page.js?v=2",
