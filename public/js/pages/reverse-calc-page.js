...
function ReverseCalcPage({onBack,onSimulate,onOpenComments,onOpenGlossario,onOpenProcesso,commentCount,EUR}){
  ...
  const lbS={fontSize:11,color:"#374151",marginBottom:3,fontFamily:"sans-serif"};
  ...
  return React.createElement("div",{style:{fontFamily:"'Inter',system-ui,sans-serif",background:N,minHeight:"100vh",color:"#111827"}},
    React.createElement(window.PageHeader||function(){return null;},{EUR:EUR,activePage:"inversa",commentCount:commentCount,onOpenComments:onOpenComments,onOpenGlossario:onOpenGlossario,onOpenProcesso:onOpenProcesso,subtitle:"Descobre o capital máximo que podes pedir com base na tua capacidade financeira · Indicativo"}),
    ...
    React.createElement("div",{style:{maxWidth:1440,margin:"0 auto",padding:"12px 14px"}},
      React.createElement("div",{style:{display:"flex",borderRadius:9,overflow:"hidden",border:"1px solid rgba(0,0,0,0.07)",marginBottom:10}},
        [{id:false,icon:"🏦",label:"Crédito Normal (LTV 80%)",c:Au},{id:true,icon:"🎓",label:"Crédito Jovem ≤35a",c:G}].map(({id,icon,label,c})=>
          React.createElement("button",{key:String(id),onClick:()=>{setMJ(id);setJovemLTV(0.9);},style:{flex:1,padding:"9px",border:"none",background:mJ===id?"rgba("+(id?"74,222,128":"201,168,76")+",0.08)":"rgba(255,255,255,1)",borderBottom:"2px solid "+(mJ===id?c:"transparent"),color:mJ===id?c:"#374151",fontSize:13,fontFamily:"sans-serif",cursor:"pointer",fontWeight:600}},icon+" "+label)
        )
      ),
      ...
      React.createElement("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(260px,1fr))",gap:10,marginBottom:10}},
        React.createElement("div",{style:secS},
          ...
          React.createElement("div",{style:{display:"flex",gap:6,marginBottom:10}},
            [1,2].map(t=>React.createElement("button",{key:t,onClick:()=>setTit(t),style:{flex:1,padding:"5px",border:"1px solid "+(tit===t?Au:"rgba(0,0,0,0.08)"),borderRadius:7,background:tit===t?"rgba(37,99,235,0.10)":"transparent",color:tit===t?Au:"#374151",fontSize:12,fontFamily:"sans-serif",cursor:"pointer",fontWeight:tit===t?700:400}},t+" Titular"+(t>1?"es":"")))
          ),
          ...
          React.createElement("div",{style:{marginTop:10}},
            ...
            React.createElement("div",{style:{fontSize:10,color:"#4b5563",marginTop:2}},"Outros créditos, rendas, pensões de alimentos, etc.")
          ),
          React.createElement("div",{style:{marginTop:10}},
          ...
          React.createElement("div",{style:{marginTop:8,padding:"8px 10px",background:"rgba(37,99,235,0.06)",border:"1px solid rgba(37,99,235,0.2)",borderRadius:8}},
            React.createElement("div",{style:{fontSize:10,color:"#374151",fontFamily:"monospace",letterSpacing:1,marginBottom:4}},"PRESTAÇÃO MÁXIMA PARA HABITAÇÃO"),
            React.createElement("div",{style:{fontSize:18,fontWeight:700,color:pMax>0?Au:R}},fE(pMax)+"/mês"),
            React.createElement("div",{style:{fontSize:10,color:"#4b5563",marginTop:2}},fE(rendT)+" × "+dsti+"% − "+fE(out))
          )
        ),
        React.createElement("div",{style:secS},
          ...
          React.createElement("div",{style:{marginBottom:10}},
            ...
            React.createElement("div",{style:{display:"flex",gap:5}},
              [["variavel","Variável (Eur.+Spread)"],["fixa","Fixa"]].map(([v,l])=>
                React.createElement("button",{key:v,onClick:()=>setTt(v),style:{flex:1,padding:"6px 8px",border:"1px solid "+(tt===v?Au:"rgba(0,0,0,0.08)"),borderRadius:6,background:tt===v?"rgba(37,99,235,0.1)":"transparent",color:tt===v?Au:"#374151",fontSize:12,fontFamily:"sans-serif",cursor:"pointer",fontWeight:tt===v?700:400}},l)
              )
            )
          ),
          tt==="variavel"?React.createElement("div",null,
              ...
              React.createElement("div",{style:{display:"flex",gap:5}},
                ["3m","6m","12m"].map(k=>{
                  ...
                  return React.createElement("button",{key:k,onClick:()=>setERef(k),style:{flex:1,padding:"5px 6px",border:"1px solid "+(eRef===k?Au:"rgba(0,0,0,0.08)"),borderRadius:6,background:eRef===k?"rgba(37,99,235,0.1)":"transparent",cursor:"pointer",fontFamily:"sans-serif",fontWeight:eRef===k?700:400}},
                    React.createElement("div",{style:{fontSize:11,color:eRef===k?Au:"#374151"}},"EUR "+k.toUpperCase()),
                    React.createElement("div",{style:{fontSize:10,color:eRef===k?Au:"#4b5563",fontFamily:"monospace"}},kv.toFixed(3).replace(".",",")+"%")
                  );
                })
              )
            ),
            React.createElement("div",{style:{marginBottom:10}},
              ...
              React.createElement("div",{style:{fontSize:10,color:"#4b5563",marginTop:2}},"Euribor "+ev.toFixed(3).replace(".",",")+"% + spread "+spr.toFixed(2).replace(".",",")+"%")
            )
          ):React.createElement("div",{style:{marginBottom:10}},
            ...
            React.createElement("div",{style:{fontSize:10,color:"#4b5563",marginTop:2}},"Taxa anual nominal fixa")
          ),
          React.createElement("div",{style:{padding:"8px 10px",background:"rgba(37,99,235,0.06)",border:"1px solid rgba(37,99,235,0.2)",borderRadius:7,marginBottom:10}},
            ...
            tt==="variavel"&&React.createElement("div",{style:{fontSize:10,color:"#4b5563"}},ev.toFixed(3).replace(".",",")+"% + "+spr.toFixed(2).replace(".",",")+" p.p. spread")
          ),
          React.createElement("div",{style:{marginBottom:10}},
          ...
          React.createElement("div",{style:{background:"rgba(37,99,235,0.06)",border:"1px solid rgba(37,99,235,0.25)",borderRadius:9,padding:14,marginTop:4}},
            ...
            React.createElement("div",{style:{marginBottom:10}},
              React.createElement("div",{style:{fontSize:11,color:"#374151"}},"Capital máximo que podes pedir"),
              React.createElement("div",{style:{fontSize:28,fontWeight:700,color:capMax>0?Au:R,lineHeight:1.1}},fE(capMax)),
              capMax>0&&React.createElement("div",{style:{fontSize:10,color:"#4b5563",marginTop:2}},pz+"a · TAN "+tan.toFixed(3).replace(".",",")+"% · prest. "+fE(pMax)+"/mês")
            ),
            React.createElement("div",{style:{marginBottom:10}},
              React.createElement("div",{style:{fontSize:11,color:"#374151"}},"Valor máximo do imóvel (LTV "+(mJ?(jovemLTV===1.0?"100%":"90%"):"80%")+")"),
              React.createElement("div",{style:{fontSize:22,fontWeight:700,color:Au}},fE(valMax))
            ),
            React.createElement("div",null,
              React.createElement("div",{style:{fontSize:11,color:"#374151"}},"Entrada mínima necessária"),
      ...
      capMax>0&&React.createElement("div",{style:{background:"rgba(249,115,22,0.06)",border:"1px solid rgba(249,115,22,0.25)",borderRadius:9,padding:"10px 14px",marginBottom:10,display:"flex",alignItems:"center",gap:16,flexWrap:"wrap"}},
        ...
        React.createElement("div",null,
          ...
          React.createElement("div",{style:{fontSize:11,color:"#4b5563"}},"vs. "+fE(capMax)+" actual · diferença: −"+fE(capMax-capS))
        )
      ),
            ...
            React.createElement("thead",null,
              React.createElement("tr",null,
                ["Prazo","Capital máximo","Valor imóvel máximo","Entrada mínima","vs. Prazo anterior"].map((h,i)=>
                  React.createElement("th",{key:i,style:{padding:"5px 8px",textAlign:i===0?"center":"right",fontSize:10,color:"#374151",fontWeight:700,letterSpacing:0.5,whiteSpace:"nowrap"}},h.toUpperCase())
                )
              )
            ),
            React.createElement("tbody",null,
              scen.map(({prazo:p,cap,val},idx)=>{
                ...
                return React.createElement("tr",{key:p,style:{background:isSelected?"rgba(37,99,235,0.06)":"transparent"}},
                  ...
                  React.createElement("td",{style:{...cellBase,textAlign:"right",color:diff&&diff>0?Au:diff&&diff<0?R:"#4b5563",borderRadius:isSelected?"0 6px 6px 0":"0",borderLeft:"none"}},diff!==null&&diff>0?"+"+fE(diff):"—")
                );
              })
            )
          )
        ),
        React.createElement("div",{style:{marginTop:8,fontSize:11,color:"#4b5563",lineHeight:1.6}},"Prestação de ",React.createElement("strong",{style:{color:Au}},fE(pMax)+"/mês")," disponível para habitação ("+dsti+"% DSTI de "+fE(rendT)+"/mês rendimento − "+fE(out)+" outros encargos).")
      ),
      ...
      React.createElement("div",{style:{padding:"8px 0 14px"}},
        React.createElement("div",{style:{fontSize:11,color:"#4b5563",textAlign:"center",marginBottom:10}},"ℹ️ Valores indicativos. O banco faz a sua própria análise de risco e crédito. Aprovação final depende de scorecard, historial e perfil do mutuário."),
