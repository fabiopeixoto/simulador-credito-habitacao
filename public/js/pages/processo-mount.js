;(function(){
  ...
  if(!React||!ReactDOM||!window._SIM||!window.ProcessoPage){
  ...
  fetch("/api/banks")
    ...
    .then(function(raw){
      ...
      ReactDOM.createRoot(el).render(h(ProcessoRoot,{initialEUR:initialEUR}));
    })
    .catch(function(){
      ReactDOM.createRoot(el).render(h(ProcessoRoot,{initialEUR:null}));
    });
})();
