;(function(){
  ...
  if(!React||!ReactDOM||!window._SIM||!window.ComparacaoPage){
  ...
  fetch("/api/banks")
    ...
    .then(function(raw){
      ...
      ReactDOM.createRoot(el).render(h(ComparacaoRoot,{initialEUR:initialEUR}));
    })
    .catch(function(){
      ReactDOM.createRoot(el).render(h(ComparacaoRoot,{initialEUR:null}));
    });
})();
