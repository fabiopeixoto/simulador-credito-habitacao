;(function(){
  ...
  if(!React||!ReactDOM||!window._SIM||!window.RentabilidadePage){
  ...
  function RentabilidadeRoot(props){
    var fe=window._SIM.FALLBACK_EUR;
  ...
  fetch("/api/banks")
    ...
    .then(function(raw){
      ...
      ReactDOM.createRoot(el).render(h(RentabilidadeRoot,{initialEUR:initialEUR}));
    })
    .catch(function(){
      ReactDOM.createRoot(el).render(h(RentabilidadeRoot,{initialEUR:null}));
    });
})();
