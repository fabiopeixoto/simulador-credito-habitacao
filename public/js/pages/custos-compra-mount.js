;(function(){
  ...
  if(!React||!ReactDOM||!window._SIM||!window.CustosCompraPage){
  ...
  function CustosCompraRoot(props){
    var fe=window._SIM.FALLBACK_EUR;
  ...
  fetch("/api/banks")
    ...
    .catch(function(){
      ReactDOM.createRoot(el).render(h(CustosCompraRoot,{initialEUR:null}));
    });
})();
