        ...
        React.createElement("tbody",null,resultados.map((b,i)=>{
          ...
          return React.createElement("tr",{key:b.rowKey,onClick:()=>setDetalheBanco(b),style:{background:bg,cursor:"pointer",WebkitTapHighlightColor:"transparent"}},
            ...
            React.createElement("td",{style:{...tdGC(i),verticalAlign:"middle",textAlign:"center"}},
              React.createElement("div",{style:{fontSize:14,fontWeight:800,color:G,whiteSpace:"nowrap"}},React.createElement("span",{style:{fontSize:9,fontWeight:600,marginRight:2}},"c/"),fP(b.tanC)),
            ...
            React.createElement("td",{style:{...tdBC,verticalAlign:"middle",position:"relative",borderRadius:"0 6px 6px 0",background:top?"rgba(37,99,235,0.1)":bg,textAlign:"center",borderLeft:"2px solid "+(top?Au:"rgba(37,99,235,0.15)")}},
              React.createElement("div",{style:{fontSize:top?17:15,fontWeight:800,color:top?Au:"#111827",whiteSpace:"nowrap",padding:"0 10px"}},React.createElement("span",{style:{fontSize:9,fontWeight:600,color:G,marginRight:2}},"c/"),fE(b.ptC)),
              React.createElement("div",{style:{fontSize:9,fontWeight:600,color:"#4b5563",whiteSpace:"nowrap",padding:"0 10px",marginTop:1}},React.createElement("span",{style:{fontSize:8,marginRight:2}},"s/"),fE(b.ptS)),
...
React.createElement("button", {onClick:handleSave,"aria-label":"Guardar simulação",title:"Guardar simulação", style:{padding:"7px 10px",background:saved?"rgba(74,222,128,0.12)":"rgba(0,0,0,0.05)",border:"1px solid "+(saved?"rgba(74,222,128,0.5)":"rgba(0,0,0,0.09)"),borderRadius:7,color:saved?G:"#374151",fontSize:14,cursor:"pointer",transition:"all 0.2s"}}, saved?"✓":"💾"),
            ...
            React.createElement("button", {key: String(id), onClick: ()=>{setModoJovem(id);if(!id)setPct(Math.min(pct,90));}, style: {flex:1,padding:"9px",border:"none",background:modoJovem===id?"rgba("+(id?"74,222,128":"201,168,76")+",0.08)":"rgba(255,255,255,1)",borderBottom:"2px solid "+(modoJovem===id?c:"transparent"),color:modoJovem===id?c:"#374151",fontSize:13,fontFamily:"sans-serif",cursor:"pointer",fontWeight:600}}, icon+" "+label)
              ...
              {l:"IS juros/mês",v:finalidade==="hpp"?"€0 (HPP isento)":melhor?fE(melhor.isM)+"/mês":"—",c:finalidade==="hpp"?G:"#374151"},
              ...
              {l:"Conta banco/mês",v:melhor?fE(melhor.contaM||0)+"/mês":"—",c:"#374151"},
          ...
          React.createElement("div", {style: {display:"flex",gap:3,marginBottom:10,flexWrap:"wrap",alignItems:"center"}}, NAV.map(({id,icon,label})=>(
            ...
            React.createElement("div", {style: {marginLeft:"auto",display:"flex",alignItems:"center",gap:8,flexWrap:"wrap",justifyContent:"flex-end"}}, React.createElement("label", {style: {display:"flex",alignItems:"center",gap:5,fontSize:11,color:"#374151",fontFamily:"sans-serif",whiteSpace:"nowrap"}}, React.createElement("span", null, "Indexante"), React.createElement("select", {"aria-label":"Filtrar bancos por Euribor oferecida", value: filtroEuribor, onChange: e=>setFiltroEuribor(e.target.value), style: {background:"#ffffff",border:"1px solid rgba(37,99,235,0.26)",color:"#111827",borderRadius:6,padding:"3px 7px",fontSize:12,cursor:"pointer",maxWidth:200}}, React.createElement("option", {value: "all"}, "Todas (3m / 6m / 12m)"), React.createElement("option", {value: "3m"}, "Só Euribor 3 meses"), React.createElement("option", {value: "6m"}, "Só Euribor 6 meses"), React.createElement("option", {value: "12m"}, "Só Euribor 12 meses"))), React.createElement("select", {value: sortBy, onChange: e=>setSortBy(e.target.value), style: {background:"#ffffff",border:"1px solid rgba(37,99,235,0.26)",color:"#111827",borderRadius:6,padding:"3px 7px",fontSize:12,cursor:"pointer"}}, React.createElement("option", {value: "prestTotal"}, "Prestação TOTAL c/produtos"), React.createElement("option", {value: "prestTotalSem"}, "Prestação TOTAL s/produtos"), React.createElement("option", {value: "comProd"}, "Capital c/ produtos"), React.createElement("option", {value: "semProd"}, "Capital s/ produtos"), React.createElement("option", {value: "taeg"}, "TAEG (custo real)"), React.createElement("option", {value: "mtic"}, "MTIC (total pago)"), React.createElement("option", {value: "poupanca"}, "Maior poupança"), React.createElement("option", {value: "spread"}, "Spread"), React.createElement("option", {value: "esforco"}, "Taxa de Esforço"), React.createElement("option", {value: "seguros"}, "Seguros mais baratos")), React.createElement("button", {onClick:()=>window.print(),"aria-label":"Imprimir ou exportar PDF", style:{padding:"4px 10px",background:"rgba(37,99,235,0.1)",border:"1px solid rgba(37,99,235,0.3)",borderRadius:6,color:Au,fontSize:12,fontFamily:"sans-serif",cursor:"pointer"}}, "🖨️ Imprimir"))
          )), nav==="comp"&&(
          React.createElement("div", {style:{background:"rgba(255,255,255,1)",border:"1px solid rgba(37,99,235,0.15)",borderRadius:11,padding:16}}, tipoTaxa==="variável"&&(
            ...
            ), filtroEuribor!=="all"&&tipoTaxa!=="variável"&&React.createElement("div", {style: {padding:"7px 12px",background:"rgba(2,132,199,0.06)",border:"1px solid rgba(2,132,199,0.2)",borderRadius:8,marginBottom:8,fontSize:11,color:"#374151",fontFamily:"sans-serif"}}, "💡 Taxa ",React.createElement("strong",null,tipoTaxa),": a coluna Euribor mostra ",React.createElement("strong",null,filtroEuribor)," como referência; só entram bancos que oferecem este indexante em variável (precário)."), resultados.length===0&&React.createElement("div", {style: {padding:"14px 16px",background:"rgba(248,113,113,0.08)",border:"1px solid rgba(248,113,113,0.35)",borderRadius:8,marginBottom:10,fontSize:12,color:"#991b1b",fontFamily:"sans-serif"}}, "Sem resultados para este filtro e tipo de taxa. Escolha «Todas» ou outro indexante, ou mude o tipo de taxa (variável / mista / fixa)."), IS_MOBILE&&renderCompTableMobile(), !IS_MOBILE&&React.createElement("div", {style: {overflowX:"auto"}}, React.createElement("table", {style: {width:"100%",borderCollapse:"separate",borderSpacing:"0 3px",fontFamily:"sans-serif",fontSize:11}}, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", {rowSpan: 2, style: thSC}, "#"), React.createElement("th", {rowSpan: 2, style: thSC}, "BANCO"), React.createElement("th", {rowSpan: 2, style: {...thSC,color:"#374151"}}, "EUR."), React.createElement("th", {colSpan: 2, style: {...thSC,textAlign:"center"}}, "SPREAD", React.createElement("br", null), React.createElement("span", {style: {fontSize:8,fontWeight:600,color:modoJovem?G:Au,letterSpacing:0.2}}, modoJovem?"Medida jovem":"Crédito normal")), React.createElement("th", {colSpan: 2, style: {...thSC,textAlign:"center"}}, "TAN"), carencia>0&&React.createElement("th", {rowSpan: 2, style: {...thSC,color:Sky,textAlign:"center"}}, "⚡CARÊNCIA", React.createElement("br", null), "/mês"), React.createElement("th", {colSpan: 2, style: {...thSC,textAlign:"center"}}, "PRESTAÇÃO CAPITAL"), React.createElement("th", {rowSpan: 2, style: {...thSC,color:"#14532d"}}, "SEGUROS+IS"), React.createElement("th", {rowSpan: 2, style: {...thSC,color:"#374151"}}, "CONTA"), React.createElement("th", {colSpan: 2, style: {...thSC,color:Au,fontWeight:700,textAlign:"center"}}, "★ TOTAL"), React.createElement("th", {rowSpan: 2, style: {...thSC,color:G}}, "POUPAR"), React.createElement("th", {rowSpan: 2, style: {...thSC,color:Au}}, "DSTI"), React.createElement("th", {rowSpan: 2, style: {...thSC,color:"#f97316"}}, "STRESS"), React.createElement("th", {rowSpan: 2, style: {...thSC,color:Sky,fontWeight:700}}, "TAEG"), React.createElement("th", {rowSpan: 2, style: {...thSC,color:"#374151"}}, "MTIC"), React.createElement("th", {rowSpan: 2, style: {...thSC,color:"#374151"}}, "CAPITAL", React.createElement("br", null), "OK?")), React.createElement("tr", null, React.createElement("th", {style: {...thSC,color:G,textAlign:"center"}}, "c/prod."), React.createElement("th", {style: {...thSC,color:R,textAlign:"center"}}, "s/prod."), React.createElement("th", {style: {...thSC,color:G,textAlign:"center"}}, "c/prod."), React.createElement("th", {style: {...thSC,color:R,textAlign:"center"}}, "s/prod."), React.createElement("th", {style: {...thSC,color:G,textAlign:"center"}}, "c/prod."), React.createElement("th", {style: {...thSC,color:R,textAlign:"center"}}, "s/prod."), React.createElement("th", {style: {...thSC,color:G,textAlign:"center",fontWeight:700}}, "c/prod."), React.createElement("th", {style: {...thSC,color:R,textAlign:"center"}}, "s/prod."))), React.createElement("tbody", null, resultados.map((b,i)=>{
                    const prevBank = i>0 ? resultados[i-1].s : null;
                    const isContinuation = prevBank === b.s;
                    const distinctBanks = new Set(resultados.slice(0,i).map(r=>r.s)).size;
                    const bg=rbg(isContinuation?distinctBanks-1:distinctBanks);
