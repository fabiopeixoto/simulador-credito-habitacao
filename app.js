...
React.createElement("button", {onClick:handleSave,"aria-label":"Guardar simulação",title:"Guardar simulação", style:{padding:"7px 10px",background:saved?"rgba(74,222,128,0.12)":"rgba(0,0,0,0.05)",border:"1px solid "+(saved?"rgba(74,222,128,0.5)":"rgba(0,0,0,0.09)"),borderRadius:7,color:saved?G:"#374151",fontSize:14,cursor:"pointer",transition:"all 0.2s"}}, saved?"✓":"💾"),
            ...
            React.createElement("div", {style:{width:1,height:22,background:"rgba(0,0,0,0.09)",margin:"0 3px",display:IS_MOBILE?"none":undefined}}),
            React.createElement("button", {onClick:handleShare,"aria-label":"Partilhar simulação", style:{padding:IS_MOBILE?"7px 8px":"7px 13px",background:shared?"rgba(74,222,128,0.12)":"rgba(2,132,199,0.08)",border:"1px solid "+(shared?"rgba(74,222,128,0.5)":"rgba(2,132,199,0.3)"),borderRadius:7,color:shared?G:"#0284c7",fontSize:IS_MOBILE?11:12,fontFamily:"sans-serif",cursor:"pointer",fontWeight:600,transition:"all 0.2s"}}, shared?(IS_MOBILE?"Copiado!":"✓ Copiado!"):(IS_MOBILE?"Partilhar":"🔗 Partilhar")),
            React.createElement("button", {onClick:()=>loadRates(true),disabled:status==="loading","aria-label":"Actualizar taxas", style:{padding:IS_MOBILE?"7px 8px":"7px 13px",background:"rgba(37,99,235,0.1)",border:"1px solid rgba(37,99,235,0.4)",borderRadius:7,color:Au,fontSize:IS_MOBILE?11:12,fontFamily:"sans-serif",cursor:status==="loading"?"not-allowed":"pointer",fontWeight:600}}, status==="loading"?(IS_MOBILE?"A actualizar…":"⏳ A actualizar..."):(IS_MOBILE?"Actualizar":"🔄 Actualizar")),
            React.createElement("button",{onClick:()=>setShowGlossario(g=>!g),"aria-label":"Glossário",style:{padding:IS_MOBILE?"7px 8px":"7px 13px",background:"rgba(37,99,235,0.08)",border:"1px solid rgba(37,99,235,0.25)",borderRadius:7,color:Au,fontSize:IS_MOBILE?11:12,fontFamily:"sans-serif",cursor:"pointer",fontWeight:600}},IS_MOBILE?"Glossário":"📖 Glossário")
