...
function TCard({n,idade,setIdade,rend,setRend,tipoC,setTipoC,colorStr}){
  ...
  return(
    React.createElement("div", {style: {background:"rgba("+colorStr+",0.05)",border:"1px solid rgba("+colorStr+",0.25)",borderRadius:10,padding:"12px 14px"}}, React.createElement("div", {style: {fontSize:12,fontWeight:700,color:"rgba("+colorStr+",1)",fontFamily:"sans-serif",marginBottom:9}}, "👤 TITULAR "+n), React.createElement("div", {style: {marginBottom:9}}, React.createElement("div", {style: {fontSize:11,color:"#374151",marginBottom:3,fontFamily:"sans-serif"}}, "IDADE"), React.createElement(SliderInput, {min: 18, max: 75, step: 1, value: idade, onChange: setIdade, color: "rgba("+colorStr+",1)", suffix: " anos", formatFn: v=>v.toString()})), React.createElement("div", {style: {marginBottom:18}}, React.createElement("div", {style: {fontSize:11,color:"#374151",marginBottom:3,fontFamily:"sans-serif"}}, "TIPO DE CONTRATO"), React.createElement("select", {value: tipoC, onChange: e=>setTipoC(e.target.value), style: {width:"auto",background:"#ffffff",border:"1px solid rgba(37,99,235,0.3)",color:"#111827",borderRadius:6,padding:"5px 8px",fontSize:12,cursor:"pointer"}}, opts.map(([v,l])=>React.createElement("option", {key: v, value: v}, l))), factor<1&&React.createElement("div", {style: {fontSize:10,color:Au,marginTop:2,fontFamily:"sans-serif"}}, "Banco considera "+Math.round(factor*100)+"% do rendimento")), React.createElement("div", null, React.createElement("div", {style: {fontSize:11,color:"#374151",marginBottom:3,fontFamily:"sans-serif"}}, "RENDIMENTO LÍQUIDO MENSAL"), React.createElement(SliderInput, {min: 500, max: 15000, step: 100, value: rend, onChange: setRend, color: "rgba("+colorStr+",1)", suffix: "€/mês", formatFn: v=>v.toLocaleString('pt-PT')}), factor<1&&React.createElement("div", {style: {fontSize:11,color:Au,fontFamily:"sans-serif",marginTop:2}}, "Rendimento considerado: "+fE(Math.round(rend*factor))+"/mês")))
  );
}
...
function App(props){
  ...
  return React.createElement(React.Fragment,null,
    React.createElement("div", {style: {fontFamily:"'Inter',system-ui,sans-serif",background:N,minHeight:"100vh",color:"#111827"}}, React.createElement("div", {style: {background:"linear-gradient(135deg,#ffffff 0%,#eff6ff 55%,#ffffff 100%)",borderBottom:"1px solid "+Au,padding:"10px 16px 0"}}, React.createElement("div", {style: {maxWidth:1440,margin:"0 auto"}}, React.createElement("div", {style: {display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexWrap:"wrap",gap:8,paddingBottom:10}}, React.createElement("div", null, React.createElement("a",{href:"/",style:{display:"flex",alignItems:"center",gap:8,textDecoration:"none",color:"inherit"}},React.createElement("img",{src:"/images/logo.png",alt:"Simulador Crédito Habitação",style:{height:40,width:"auto",flexShrink:0}}),React.createElement("h1",{style:{margin:0,fontSize:21,fontWeight:700,color:"#111827",letterSpacing:-0.3,fontFamily:"'Inter',system-ui,sans-serif"}},"Simulador Crédito Habitação")), React.createElement("div", {style: {fontSize:11,color:"#374151",fontFamily:"sans-serif",marginTop:2}}, "Portugal · 14 bancos · Euribor em tempo real"), React.createElement("div", {style:{display:"flex",gap:5,marginTop:7,flexWrap:"wrap"}}, ["3m","6m","12m"].map(k=>{const v=EUR[k]||FALLBACK_EUR[k];const[c,bg]=EUR_COLORS[k];return React.createElement("div",{key:k,style:{display:"flex",alignItems:"center",gap:IS_MOBILE?4:5,padding:IS_MOBILE?"3px 6px":"3px 9px",background:bg,borderRight:"1px solid rgba(0,0,0,0.04)",borderRadius:4,flex:IS_MOBILE?1:undefined,justifyContent:IS_MOBILE?"center":undefined}},React.createElement("span",{style:{color:c,fontWeight:700,fontSize:10,fontFamily:"monospace",letterSpacing:1}},IS_MOBILE?k.toUpperCase():"EUR "+k.toUpperCase()),React.createElement("span",{style:{color:"#111827",fontSize:13,fontWeight:700,fontFamily:"monospace"}},v.valor.toFixed(3).replace(".",",")+"%"),!IS_MOBILE&&v.data&&React.createElement("span",{style:{color:"#374151",fontSize:10,fontFamily:"sans-serif",marginLeft:2}},v.data));}),React.createElement("div",{style:{display:"flex",alignItems:"center",gap:4,marginLeft:IS_MOBILE?0:6,paddingLeft:IS_MOBILE?0:8,borderLeft:IS_MOBILE?"none":"1px solid rgba(0,0,0,0.08)",fontSize:11,color:stColor,fontFamily:"sans-serif"}},stIcon+" "+msg,ts&&status!=="loading"&&React.createElement("span",{style:{color:"#374151",marginLeft:3}},ts.toLocaleTimeString("pt-PT",{hour:"2-digit",minute:"2-digit"}))))), React.createElement("div", {style:{display:"flex",flexDirection:"column",gap:4,alignItems:"flex-end"}}, React.createElement("div", {style:{display:"flex",gap:IS_MOBILE?4:5,alignItems:"center",flexWrap:"wrap"}},
React.createElement("button", {onClick:handleSave,"aria-label":"Guardar simulação",title:"Guardar simulação", style:{padding:"7px 10px",background:saved?"rgba(74,222,128,0.12)":"rgba(0,0,0,0.05)",border:"1px solid "+(saved?"rgba(74,222,128,0.5)":"rgba(0,0,0,0.09)"),borderRadius:7,color:saved?G:"#374151",fontSize:14,cursor:"pointer",transition:"all 0.2s"}}, saved?"✓":"💾"),
            React.createElement("button", {onClick:()=>setShowHist(h=>!h),"aria-label":"Histórico de simulações",title:"Histórico de simulações", style:{padding:"7px 10px",background:showHist?"rgba(2,132,199,0.12)":"rgba(0,0,0,0.05)",border:"1px solid "+(showHist?"rgba(2,132,199,0.4)":"rgba(0,0,0,0.09)"),borderRadius:7,color:showHist?Sky:"#374151",fontSize:14,cursor:"pointer",transition:"all 0.2s"}}, histSaved.length>0?"📋 "+histSaved.length:"📋"),
            React.createElement("div", {style:{width:1,height:22,background:"rgba(0,0,0,0.09)",margin:"0 3px"}}),
            React.createElement("button", {onClick:handleShare,"aria-label":"Partilhar simulação",title:"Partilhar simulação", style:{padding:"7px 10px",background:shared?"rgba(74,222,128,0.12)":"rgba(2,132,199,0.08)",border:"1px solid "+(shared?"rgba(74,222,128,0.5)":"rgba(2,132,199,0.3)"),borderRadius:7,color:shared?G:"#0284c7",fontSize:14,cursor:"pointer",fontWeight:600,transition:"all 0.2s"}}, shared?"✓":"🔗"),
            React.createElement("button", {onClick:()=>loadRates(true),disabled:status==="loading","aria-label":"Actualizar taxas", style:{padding:IS_MOBILE?"7px 8px":"7px 13px",background:"rgba(37,99,235,0.1)",border:"1px solid rgba(37,99,235,0.4)",borderRadius:7,color:Au,fontSize:IS_MOBILE?11:12,fontFamily:"sans-serif",cursor:status==="loading"?"not-allowed":"pointer",fontWeight:600}}, status==="loading"?"⏳ A actualizar...":"🔄 Actualizar"),
            React.createElement("button",{onClick:()=>setShowGlossario(g=>!g),"aria-label":"Glossário",style:{padding:IS_MOBILE?"7px 8px":"7px 13px",background:"rgba(37,99,235,0.08)",border:"1px solid rgba(37,99,235,0.25)",borderRadius:7,color:Au,fontSize:IS_MOBILE?11:12,fontFamily:"sans-serif",cursor:"pointer",fontWeight:600}},"📖 Glossário")
            ))),window.NavTabs?React.createElement(window.NavTabs,{activePage:"simulador",commentCount:commentTotal,onOpenComments:()=>setShowComments(c=>!c)}):null,React.createElement("div",{style:{paddingBottom:8}},React.createElement("span",{style:{fontSize:11,color:"#374151"}},"Compara prestações de 14 bancos com Euribor actualizado, spreads, seguros, TAEG e DSTI · Indicativo, não substitui a FINE")))),window.NoticeBanner&&React.createElement(window.NoticeBanner,null), React.createElement("div", {style: {maxWidth:1440,margin:"0 auto",padding:"10px 14px"}}, React.createElement("div", {style: {display:"flex",borderRadius:9,overflow:"hidden",border:"1px solid rgba(0,0,0,0.07)",marginBottom:10}}, [{id:false,icon:"🏦",label:"Crédito Normal",c:Au},{id:true,icon:"🎓",label:"Crédito Jovem ≤35 anos",c:G}].map(({id,icon,label,c})=>(
            React.createElement("button", {key: String(id), onClick: ()=>{setModoJovem(id);if(!id)setPct(Math.min(pct,90));}, style: {flex:1,padding:"10px 9px",border:"none",background:modoJovem===id?c:"rgba(255,255,255,1)",borderBottom:"3px solid "+(modoJovem===id?c:"transparent"),color:modoJovem===id?"#fff":"#374151",fontSize:13,fontFamily:"sans-serif",cursor:modoJovem===id?"default":"pointer",fontWeight:modoJovem===id?700:600,transition:"background 0.15s,color 0.15s"}}, icon+" "+label)
          ))), React.createElement("div", {style: {background:"rgba(0,0,0,0.03)",border:"1px solid rgba(37,99,235,0.16)",borderRadius:11,padding:"13px 14px 10px",marginBottom:10}}, React.createElement("div", {onClick:IS_MOBILE?()=>setParamsOpen(o=>!o):undefined,role:IS_MOBILE?"button":undefined,"aria-expanded":IS_MOBILE?paramsOpen:undefined,style: {fontSize:11,letterSpacing:3,color:IS_MOBILE?"#fff":Au,background:IS_MOBILE?(modoJovem?G:Au):undefined,borderRadius:IS_MOBILE?7:undefined,padding:IS_MOBILE?"10px 12px":undefined,fontFamily:"monospace",marginBottom:showParams?10:0,display:"flex",alignItems:"center",justifyContent:"space-between",cursor:IS_MOBILE?"pointer":undefined,WebkitTapHighlightColor:"transparent"}}, "PARÂMETROS GLOBAIS", IS_MOBILE&&React.createElement("span", {style: {fontSize:14,fontWeight:800,lineHeight:1,color:"#fff",transform:paramsOpen?"rotate(90deg)":"none",transition:"transform 0.2s"}}, "›")), showParams&&React.createElement("div", {style: {display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(135px,1fr))",gap:11,marginBottom:12,alignItems:"start"}}, React.createElement("div", null, React.createElement("div", {style: {fontSize:11,color:"#374151",marginBottom:3,fontFamily:"sans-serif"}}, "VALOR DO IMÓVEL (Aquisição)"), React.createElement(SliderInput, {min: 50000, max: modoJovem?450000:1500000, step: 1000, value: Math.min(valorImovel,modoJovem?450000:1500000), onChange: v=>setValorImovel(v), color: Au, suffix: "€", formatFn: v=>v.toLocaleString('pt-PT')})), React.createElement("div", null, React.createElement("div", {style: {fontSize:11,color:"#374151",marginBottom:3,fontFamily:"sans-serif"}}, "AVALIAÇÃO (opcional)"), React.createElement(SliderInput, {min: 0, max: modoJovem?450000:1500000, step: 1000, value: valorAvaliacao, onChange: v=>setValorAvaliacao(v), color: avalAbaixo?R:"#374151", suffix: "€", formatFn: v=>v===0?"= Valor de aquisição":v.toLocaleString('pt-PT')}), avalAbaixo&&(
                ...
                React.createElement("div", {style: {fontSize:10,color:"#374151",fontFamily:"sans-serif",marginTop:2}}, "Deixar em 0 = assume igual ao preço de compra")
              )), React.createElement("div", null, React.createElement("div", {style: {fontSize:11,color:"#374151",marginBottom:3,fontFamily:"sans-serif"}}, "FINANCIAMENTO (máx. "+maxPctFin+"%)"), React.createElement(SliderInput, {min: 10, max: maxPctFin, step: 1, value: pctR, onChange: v=>setPct(v), color: modoJovem?G:Au, suffix: "%", formatFn: v=>v.toString()}), React.createElement("div", {style: {fontSize:10,color:"#374151",fontFamily:"sans-serif",marginTop:2}}, "= "+fE(capital)+" · Entrada: "+fE(entrada))), React.createElement("div", null, React.createElement("div", {style: {fontSize:11,color:"#374151",marginBottom:3,fontFamily:"sans-serif"}}, "PRAZO (máx. "+prazoMax+"a)"), React.createElement(SliderInput, {min: 10, max: prazoMax, step: 1, value: prazoR, onChange: v=>setPrazo(v), color: Au, suffix: " anos", formatFn: v=>v.toString()}), React.createElement("div", {style: {fontSize:10,color:"#374151",fontFamily:"sans-serif",marginTop:2}}, prazoLimLabel)), React.createElement("div", {style:{display:"flex",flexWrap:"wrap",gap:11}}, React.createElement("div", {style:{flex:"1 1 110px"}}, React.createElement("div", {style: {fontSize:11,color:"#374151",marginBottom:3,fontFamily:"sans-serif"}}, "TIPO DE TAXA"), ["variável","mista","fixa"].map(t=>(
                React.createElement("button", {key: t, onClick: ()=>setTipoTaxa(t), style: {display:"block",width:"100%",marginBottom:3,padding:"5px 7px",border:"1px solid "+(tipoTaxa===t?Au:"rgba(0,0,0,0.06)"),borderRadius:5,background:tipoTaxa===t?"rgba(37,99,235,0.1)":"transparent",color:tipoTaxa===t?Au:"#374151",fontSize:11,fontFamily:"sans-serif",cursor:"pointer",textAlign:"left",whiteSpace:"nowrap"}}, t==="variável"?"Variável — Euribor":t==="mista"?"Mista — fixa inicial":"Fixa — todo o prazo")
              ))), React.createElement("div", {style:{flex:"1 1 110px"}}, React.createElement("div", {style: {fontSize:11,color:"#374151",marginBottom:3,fontFamily:"sans-serif"}}, "FINALIDADE"), [["hpp","🏠 HPP (1.ª habitação)"],["hab2","🏖️ 2.ª habitação"],["arrendamento","🔑 Arrendamento"]].map(([v,l])=>(
                React.createElement("button", {key: v, onClick: ()=>setFinalidade(v), style: {display:"block",width:"100%",marginBottom:3,padding:"5px 7px",border:"1px solid "+(finalidade===v?Au:"rgba(0,0,0,0.06)"),borderRadius:5,background:finalidade===v?"rgba(37,99,235,0.1)":"transparent",color:finalidade===v?Au:"#374151",fontSize:11,fontFamily:"sans-serif",cursor:"pointer",textAlign:"left",whiteSpace:"nowrap"}}, l)
              )), finalidade!=="hpp"&&React.createElement("div", {style: {fontSize:10,color:R,fontFamily:"sans-serif",marginTop:2}}, "Spread +"+((FINALIDADE_ADDON[finalidade]||0)*100).toFixed(0)+"pp · LTV máx. "+FINALIDADE_MAX_LTV[finalidade]+"%"))), React.createElement("div", null, React.createElement("div", {style: {fontSize:11,color:"#374151",marginBottom:3,fontFamily:"sans-serif"}}, "OPÇÕES ADICIONAIS"), React.createElement("label", {style: {display:"flex",alignItems:"center",gap:5,marginBottom:6,fontSize:11,color:"#374151",fontFamily:"sans-serif",cursor:"pointer"}}, React.createElement("input", {type: "checkbox", checked: certA, onChange: e=>setCertA(e.target.checked), style: {accentColor:G}}), "🏠 Cert. A/B (-0,15% spread)"), React.createElement("label", {style: {display:"flex",alignItems:"center",gap:5,marginBottom:6,fontSize:11,color:"#374151",fontFamily:"sans-serif",cursor:"pointer"}}, React.createElement("input", {type: "checkbox", checked: segProtecao, onChange: e=>setSegProtecao(e.target.checked), style: {accentColor:Sky}}), "🛡️ Seg. Protecção Crédito (+"+fE(Math.round(capital*0.00012))+"/mês)"), React.createElement("div", {style: {fontSize:11,color:"#374151",marginBottom:3,fontFamily:"sans-serif"}}, "CARÊNCIA DE CAPITAL (meses)"), React.createElement(SliderInput, {min: 0, max: 24, step: 1, value: carencia, onChange: setCarencia, color: Sky, suffix: " meses", formatFn: v=>v===0?"0":v.toString()}), React.createElement("div", {style: {fontSize:12,color:carencia>0?Sky:"#374151",fontFamily:"sans-serif",marginTop:2}}, carencia===0?"Sem carência":"Só juros durante "+carencia+"m"))), React.createElement("div", {style: {borderTop:"1px solid rgba(0,0,0,0.06)",paddingTop:11,marginBottom:11}}, React.createElement("div", {style: {display:"flex",alignItems:"center",gap:10,marginBottom:showTitulares?9:0}}, React.createElement("div", {onClick:IS_MOBILE?()=>setTitularesOpen(o=>!o):undefined,role:IS_MOBILE?"button":undefined,"aria-expanded":IS_MOBILE?titularesOpen:undefined,style: {fontSize:11,color:IS_MOBILE?"#fff":Au,background:IS_MOBILE?(modoJovem?G:Au):undefined,borderRadius:IS_MOBILE?7:undefined,padding:IS_MOBILE?"10px 12px":undefined,flex:IS_MOBILE?1:undefined,justifyContent:IS_MOBILE?"space-between":undefined,fontFamily:"monospace",letterSpacing:3,display:"flex",alignItems:"center",gap:6,cursor:IS_MOBILE?"pointer":undefined,WebkitTapHighlightColor:"transparent"}}, "TITULARES", IS_MOBILE&&React.createElement("span", {style: {fontSize:14,fontWeight:800,lineHeight:1,color:"#fff",transform:titularesOpen?"rotate(90deg)":"none",transition:"transform 0.2s"}}, "›")), showTitulares&&[1,2].map(t=>(
                React.createElement("button", {key: t, onClick: ()=>setTitulares(t), style: {padding:"4px 14px",border:"1px solid "+(titulares===t?Au:"rgba(0,0,0,0.08)"),borderRadius:20,background:titulares===t?"rgba(37,99,235,0.12)":"transparent",color:titulares===t?Au:"#374151",fontSize:13,fontFamily:"sans-serif",cursor:"pointer",fontWeight:titulares===t?700:400}}, t+" Titular"+(t>1?"es":""))
              )), showTitulares&&is2&&React.createElement("span", {style: {fontSize:11,color:"#374151",fontFamily:"sans-serif"}}, "Rend. conjunto considerado: ", React.createElement("strong", {style: {color:G}}, fE(rendT)+"/mês"))), showTitulares&&React.createElement("div", {style: {display:"grid",gridTemplateColumns:IS_MOBILE?(is2?"1fr 1fr":"1fr"):"repeat(auto-fit,minmax(210px,1fr))",gap:IS_MOBILE?8:12,marginBottom:12,alignItems:"start"}}, React.createElement(TCard, {n: 1, idade: idade1, setIdade: setIdade1, rend: rend1, setRend: setRend1, tipoC: tipoC1, setTipoC: setTipoC1, colorStr: "201,168,76"}), is2&&React.createElement(TCard, {n: 2, idade: idade2, setIdade: setIdade2, rend: rend2, setRend: setRend2, tipoC: tipoC2, setTipoC: setTipoC2, colorStr: "74,222,128"}), React.createElement("div", {style:{display:"grid",gap:11,paddingTop:IS_MOBILE?0:33,gridColumn:IS_MOBILE?"1 / -1":undefined}}, React.createElement("div", null, React.createElement("div", {style: {fontSize:11,color:"#374151",marginBottom:3,fontFamily:"sans-serif"}}, "DEPENDENTES (−€400/dep.)"), React.createElement(SliderInput, {min: 0, max: 10, step: 1, value: dependentes, onChange: setDependentes, color: "#f97316", suffix: " dep.", formatFn: v=>v.toString()}), dependentes>0&&React.createElement("div", {style: {fontSize:10,color:"#f97316",fontFamily:"sans-serif",marginTop:2}}, "−"+fE(dependentes*400)+"/mês no DSTI")), React.createElement("div", null, React.createElement("div", {style: {fontSize:11,color:"#374151",marginBottom:3,fontFamily:"sans-serif"}}, "OUTROS ENCARGOS MENSAIS"), React.createElement(SliderInput, {min: 0, max: 50000, step: 50, value: outros, onChange: setOutros, color: "#f97316", suffix: "€/mês", formatFn: v=>v.toLocaleString('pt-PT')}), React.createElement("div", {style: {fontSize:10,color:"#374151",fontFamily:"sans-serif",marginTop:2,lineHeight:1.5}}, "Inclui todos os encargos mensais fixos existentes: outros créditos (automóvel, pessoal, estudante), rendas, pensões de alimentos, avales, etc. O banco considera estes encargos no cálculo da taxa de esforço (DSTI).")))))), showHist&&histSaved.length>0&&React.createElement("div", {style:{position:"fixed",inset:0,zIndex:9999,background:"rgba(0,0,0,0.5)",display:"flex",alignItems:"center",justifyContent:"center"},onClick:()=>setShowHist(false)},
          ...
          React.createElement("div", {style: {marginBottom:10}}, React.createElement("div", {style: {display:"flex",flexWrap:"wrap",borderRadius:9,overflow:"hidden",border:"1px solid rgba(0,0,0,0.07)",background:IS_MOBILE?"rgba(0,0,0,0.06)":"rgba(255,255,255,1)",rowGap:IS_MOBILE?1:0}}, NAV.map(({id,icon,label})=>(
            ...
            React.createElement("div", {style: {marginTop:8,display:"flex",alignItems:"center",gap:IS_MOBILE?5:8,flexWrap:IS_MOBILE?"nowrap":"wrap",justifyContent:"flex-end"}}, React.createElement("label", {style: {display:"flex",alignItems:"center",gap:5,fontSize:11,color:"#374151",fontFamily:"sans-serif",whiteSpace:"nowrap",flex:IS_MOBILE?"1 1 0":undefined,minWidth:0}}, React.createElement("select", {className:"sel-compact","aria-label":"Filtrar bancos por Euribor oferecida", value: filtroEuribor, onChange: e=>setFiltroEuribor(e.target.value), style: {background:"#ffffff",border:"1px solid rgba(37,99,235,0.26)",color:"#111827",borderRadius:6,padding:"3px 7px",fontSize:12,cursor:"pointer",maxWidth:200,flex:IS_MOBILE?1:undefined,minWidth:0}}, React.createElement("option", {value: "all"}, "Todas (3m / 6m / 12m)"), React.createElement("option", {value: "3m"}, "Só Euribor 3 meses"), React.createElement("option", {value: "6m"}, "Só Euribor 6 meses"), React.createElement("option", {value: "12m"}, "Só Euribor 12 meses"))), React.createElement("select", {className:"sel-compact", value: sortBy, onChange: e=>setSortBy(e.target.value), style: {background:"#ffffff",border:"1px solid rgba(37,99,235,0.26)",color:"#111827",borderRadius:6,padding:"3px 7px",fontSize:12,cursor:"pointer",flex:IS_MOBILE?"1 1 0":undefined,minWidth:0}}, React.createElement("option", {value: "prestTotal"}, "Prestação TOTAL c/produtos"), React.createElement("option", {value: "prestTotalSem"}, "Prestação TOTAL s/produtos"), React.createElement("option", {value: "comProd"}, "Capital c/ produtos"), React.createElement("option", {value: "semProd"}, "Capital s/ produtos"), React.createElement("option", {value: "taeg"}, "TAEG (custo real)"), React.createElement("option", {value: "mtic"}, "MTIC (total pago)"), React.createElement("option", {value: "poupanca"}, "Maior poupança"), React.createElement("option", {value: "spread"}, "Spread"), React.createElement("option", {value: "esforco"}, "Taxa de Esforço"), React.createElement("option", {value: "seguros"}, "Seguros mais baratos")), React.createElement("button", {onClick:()=>window.print(),"aria-label":"Imprimir ou exportar PDF",title:"Imprimir ou exportar PDF", style:{padding:"4px 8px",background:"rgba(37,99,235,0.1)",border:"1px solid rgba(37,99,235,0.3)",borderRadius:6,color:Au,fontSize:12,fontFamily:"sans-serif",cursor:"pointer",flexShrink:0}}, "🖨️"))
          )), nav==="comp"&&(
          React.createElement("div", {style:{background:"rgba(255,255,255,1)",border:"1px solid rgba(37,99,235,0.15)",borderRadius:11,padding:16}}, tipoTaxa==="variável"&&(
              React.createElement("div", {style: {padding:"7px 12px",background:"rgba(2,132,199,0.06)",border:"1px solid rgba(2,132,199,0.2)",borderRadius:8,marginBottom:8,fontSize:11,color:"#374151",fontFamily:"sans-serif"}}, filtroEuribor==="all"?React.createElement(React.Fragment,null,"💡 Filtro «Indexante» na Comparação: com «Todas (3m / 6m / 12m)», cada linha é um par banco + Euribor; quem oferece mais do que um indexante aparece várias vezes. Com «Só Euribor …» ficam só os bancos com esse tenor no CH (precário), uma linha por banco. A ordem do quadro segue o critério do menu ao lado.",React.createElement("br",null),"✓ = spread confirmado pela API. Spread inclui ajuste LTV ("+pctR+"%) e finalidade."):React.createElement(React.Fragment,null,"💡 Com «Só Euribor ",React.createElement("strong",null,filtroEuribor),"» seleccionado: só entram bancos que disponibilizam esse indexante no CH (precário), uma linha por banco. Ordenação: critério do menu ao lado.",React.createElement("br",null),"✓ = spread confirmado pela API. Spread inclui ajuste LTV ("+pctR+"%) e finalidade."))
            ), filtroEuribor!=="all"&&tipoTaxa!=="variável"&&React.createElement("div", {style: {padding:"7px 12px",background:"rgba(2,132,199,0.06)",border:"1px solid rgba(2,132,199,0.2)",borderRadius:8,marginBottom:8,fontSize:11,color:"#374151",fontFamily:"sans-serif"}}, "💡 Taxa ",React.createElement("strong",null,tipoTaxa),": a coluna Euribor mostra ",React.createElement("strong",null,filtroEuribor)," como referência; só entram bancos que oferecem este indexante em variável (precário)."), resultados.length===0&&React.createElement("div", {style: {padding:"14px 16px",background:"rgba(248,113,113,0.08)",border:"1px solid rgba(248,113,113,0.35)",borderRadius:8,marginBottom:10,fontSize:12,color:"#991b1b",fontFamily:"sans-serif"}}, "Sem resultados para este filtro e tipo de taxa. Escolha «Todas» ou outro indexante, ou mude o tipo de taxa (variável / mista / fixa)."), IS_MOBILE&&window.CompTableMobile&&React.createElement(window.CompTableMobile, {resultados,capital,onSelectBank:setDetalheBanco}), !IS_MOBILE&&window.CompTableDesktop&&React.createElement(window.CompTableDesktop, {resultados,ctx:{modoJovem,carencia,capital,segProtecao,segProtMensal,is2,rendT}})
              ...
              React.createElement("div", {style: {padding:"10px 14px",background:"rgba(37,99,235,0.06)",border:"1px solid rgba(37,99,235,0.2)",borderRadius:9,fontFamily:"sans-serif",fontSize:12,color:"#374151"}}, "ℹ️ Selecione taxa variável para ver os cenários de Euribor.")
                ...
                React.createElement("div", null, React.createElement("div", {style:{display:"flex",alignItems:"center",gap:8,marginBottom:14,flexWrap:"wrap"}}, React.createElement("span", {style:{fontSize:11,color:"#374151",fontFamily:"sans-serif",flexShrink:0}}, "Banco:"), React.createElement("select", {value:bancoCenS,onChange:e=>setBancoCen(e.target.value),style:{flex:1,minWidth:140,background:"#ffffff",border:"1px solid rgba(37,99,235,0.35)",color:"#111827",borderRadius:7,padding:"5px 9px",fontSize:13,fontFamily:"sans-serif",cursor:"pointer",fontWeight:600}}, resultados.filter((r,i,arr)=>arr.findIndex(x=>x.s===r.s)===i).map(r=>(React.createElement("option", {key:r.s,value:r.s}, r.name+(melhor&&r.s===melhor.s?" ⭐ (melhor)":"")+" · Eur."+r.ref+" · TAN "+fP(r.tanC))))), melhor&&bancoCenS!==melhor.s&&React.createElement("button", {onClick:()=>setBancoCen(melhor.s),style:{padding:"4px 10px",background:"rgba(37,99,235,0.12)",border:"1px solid rgba(37,99,235,0.35)",borderRadius:6,color:Au,fontSize:11,fontFamily:"sans-serif",cursor:"pointer"}}, "⭐ "+melhor.name)), React.createElement("div", {style: {background:"rgba(255,255,255,1)",border:"1px solid rgba(37,99,235,0.18)",borderRadius:11,padding:16,marginBottom:14}}, React.createElement("div", {style: {fontSize:12,letterSpacing:2,color:Au,fontFamily:"monospace",marginBottom:8}}, "CENÁRIOS — "+(bancoCenRow?.name||melhor.name)+" · spread "+fP(bancoCenRow?.sCom||melhor.sCom)+" · Eur.actual "+(bancoCenRow?.ev||melhor.ev).toFixed(3).replace(".",",")+"%  (inclui IS juros + seguros)"), React.createElement("div", {style: {overflowX:"auto"}}, React.createElement("table", {style: {width:"100%",borderCollapse:"separate",borderSpacing:"0 5px",fontFamily:"sans-serif",fontSize:13}}, React.createElement("thead", null, React.createElement("tr", null, ["Cenário","Euribor","TAN","Capital","IS Juros","+ Seguros","TOTAL","DSTI","Stress","DSTI Stress"].map(h=>React.createElement("th", {key: h, style: {...thS,textAlign:"center"}}, h.toUpperCase())))), React.createElement("tbody", null, cenarios.map(c=>(
                    ...
                    React.createElement("div", {style: {background:"rgba(255,255,255,1)",border:"1px solid rgba(2,132,199,0.25)",borderRadius:11,padding:16}}, React.createElement("div", {style: {fontSize:12,letterSpacing:2,color:Sky,fontFamily:"monospace",marginBottom:8}}, "FIXA vs. VARIÁVEL — PONTO DE EQUILÍBRIO"), React.createElement("div", {style: {display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:8,marginBottom:10}}, [{l:"Taxa Fixa ("+fixaB.name+")",v:fP(fixaB.fCom),c:Sky,note:null},{l:"Taxa Variável actual",v:fP(fixaB.tanC),c:G,note:"Eur."+fixaB.ev.toFixed(3).replace(".",",")+"%"},{l:"Euribor break-even",v:brkEur?fP(brkEur):"—",c:brkEur&&fixaB.ev>brkEur?R:Au,note:brkEur&&fixaB.ev>brkEur?"⚠ já acima — fixa vantajosa":brkEur?"actual abaixo — variável melhor":null}].map(({l,v,c,note})=>React.createElement("div", {key:l,style:{background:"rgba(255,255,255,1)",border:"1px solid rgba(0,0,0,0.06)",borderRadius:8,padding:"10px 12px"}}, React.createElement("div", {style:{fontSize:10,color:"#374151",fontFamily:"monospace",letterSpacing:1,marginBottom:4}}, l.toUpperCase()), React.createElement("div", {style:{fontSize:18,fontWeight:700,color:c,fontFamily:"sans-serif"}}, v), note&&React.createElement("div", {style:{fontSize:10,color:c,fontFamily:"sans-serif",marginTop:2,opacity:0.85}}, note)))), React.createElement("div", {style: {display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}, ["variável","fixa"].map(tipo=>{
                          ...
                          return(
                            React.createElement("div", {key: tipo, style: {background:"rgba("+(tipo==="variável"?"74,222,128":"125,211,252")+",0.06)",border:"1px solid rgba("+(tipo==="variável"?"74,222,128":"125,211,252")+",0.25)",borderRadius:9,padding:"12px 14px"}}, React.createElement("div", {style: {fontSize:12,fontWeight:700,color:clr,fontFamily:"sans-serif",textTransform:"uppercase",marginBottom:6}}, "Taxa "+tipo), React.createElement("div", {style: {fontSize:20,fontWeight:700,color:"#111827",fontFamily:"sans-serif",lineHeight:1}}, fE(p)+"/mês"), React.createElement("div", {style: {fontSize:11,color:"#374151",fontFamily:"sans-serif",marginBottom:4}}, "capital"), React.createElement("div", {style: {fontSize:14,fontWeight:700,color:clr,fontFamily:"sans-serif"}}, fE(pt)+"/mês total"), React.createElement("div", {style: {fontSize:11,color:"#374151",fontFamily:"sans-serif",marginTop:4}}, "IS juros: "+fE(isM2)+" · Juros totais: "+fE(p*prazoR*12-capital)))
                          );
                        })))
                  ))
              ))
