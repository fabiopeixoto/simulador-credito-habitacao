...
const BANKS_STATIC = [
  ...
  {name:"Abanca",           s:"ABANCA",color:"#00529b", refs:["3m","6m","12m"],  jOk:true,  carenciaMax:0,  tipos:["variável","mista"],         promos:["Indexante Euribor 6m ou 12m","Taxa fixa 2,70% 1.º/2.º ano"],                                                                                   prod:"Dom. ≥1.000€ + Seg. Vida + Multi + Cartão",                              jProd:"TAN fixa 2,70% 1.º ano → spread 0,70%"},
