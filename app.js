...
const FALLBACK_BANK_DATA = {
  ...
  SANTR: {sCom:0.80,sSem:1.90,mCom:3.25,mSem:4.35,fCom:4.40,fSem:4.40,jsCom:0.80,jsSem:1.90,promoPeriodo:36,promoSpread:0.50,dossier:725,avaliacao:230,contaMes:2.90,capMin:30000, capMax:3000000,vRef:22.55,mAno:246,minutas:0,  jovemIsenta:false,jovemSameSpread:true}, // simulador Santander mai.2026 (200k/30–40a): E6+spread promo 0,50%→base 0,80% c/pack (3a); s/pack 1,90% fixo. TAN var. c/pack anos-seg. 3,254%; s/pack 4,354%. CHjovem mesmo spread (sem desconto de spread; benefício=garantia Estado+isenções fiscais). Formalização 725€, avaliação 230€
