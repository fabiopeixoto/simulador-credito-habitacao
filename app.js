...
const FALLBACK_BANK_DATA = {
  ...
  CTT:   {sCom:0.70,sSem:2.60,mCom:3.65,mSem:5.35,fCom:4.70,fSem:4.70,jsCom:0.70,jsSem:2.60,promoPeriodo:0, promoSpread:null,dossier:280, avaliacao:230,contaMes:1.73,capMin:25000, capMax:1000000,vRef:15.71,mAno:170,minutas:160,jovemIsenta:false}, // Precário (abr.2026 no PDF analisado): §18.1 CH EURIBOR 3/6/12m + spread 0,70–2,60%; E12 abr.2026 2,747%+2,60%→TAN 5,347% (ex. TAEG); mista 2a TAN fixa ilustr. 3,65%; fixa 4,70%. Comissões Parte I §2.1: abertura 280€, aval. 230€+IS, formalização 160€+IS. Conta: 20€/ano+IS4% nos ex. TAEG ≈1,73€/mês. CH Sinal Jovem: TAN fixa 5% (produto distinto). Mín. 25k€ (nota 6 FINE). BANKS_STATIC refs 3/6/12m
  ...
  ACTVO: {sCom:0.80,sSem:1.50,mCom:3.50,mSem:4.25,fCom:4.05,fSem:5.05,jsCom:0.68,jsSem:1.38,promoPeriodo:24,promoSpread:0,  dossier:300,avaliacao:250,contaMes:0,   capMin:20000, capMax:3000000,vRef:19.84,mAno:256,minutas:0,  jovemIsenta:true}, // Spreads variáveis 0,70–1,50% (preçário BCP secção 18, CH grupo); sCom/sSem e CH Jovem alinhados ao SEED / simulador
  ...
  MNTPO: {sCom:0.70,sSem:2.30,mCom:3.15,mSem:4.75,fCom:3.10,fSem:5.80,jsCom:0.58,jsSem:1.38,promoPeriodo:0, promoSpread:null,dossier:312,avaliacao:239,contaMes:3.11,capMin:10000, capMax:2000000,vRef:8.29, mAno:79, minutas:0,  jovemIsenta:false}, // PRE-FT mai.2026 §18.1 CH c/ garantia: EUR 3M/6M/12M + spread 0,70% a +2,30% (conta à ordem no Montepio); +1,50% a +2,30% noutro IC. m/f alinhados a E6 2,454% (notas TAEG) e taxa base fixa + spread. Comissões 300€/230€ +IS 4%≈312/239€ (PRE-FC fev.2026). Conta Base c/ ordenado 2,99€/mês+IS≈3,11€. js: estimativa jovem (folheto remete regimes bonificados). BANKS_STATIC refs 3/6/12m
...
const BANKS_STATIC = [
  ...
  {name:"Banco CTT",        s:"CTT",   color:"#e30613", refs:["3m","6m","12m"], jOk:true,  carenciaMax:0,  tipos:["variável","mista"],         promos:["Spread CH 0,70–2,60% (§18.1; Euribor 3/6/12m)","Dom.+Seg. Vida+Multi (spread reduzido vs base)","CH Sinal Jovem: TAN fixa 5% (nota §18.1)"], prod:"Seg. Vida + Multirriscos + Dom. CTT",                                     jProd:"Taxa mista 2a TAN fixa ilustr. 3,65%; Sinal Jovem 5% fixo"},
  ...
  {name:"ActivoBank",       s:"ACTVO", color:"#6d1e8a", refs:["3m","6m","12m"], jOk:true,  carenciaMax:0,  tipos:["variável","mista"],         promos:["Spread 0% primeiros 2 anos","3 indexantes"],                                                                      prod:"Cartão créd.≥100€ + Créd.pessoal + Dom. + Seg. Ocidental + Ageas",      jProd:"Spread 0% 2 anos; 100% garantia Estado"},
  ...
  {name:"Banco Montepio",   s:"MNTPO", color:"#7a0f2e", refs:["3m","6m","12m"], jOk:true,  carenciaMax:24, tipos:["variável","mista"],         promos:["CH §18.1: Euribor 3/6/12m + spread 0,70–2,30%","Cashback 1,5%"],                                                                                                  prod:"Conta Ordenado + Cartão ≥500€/sem + Seg. Vida + Multirriscos Lusitania", jProd:"100% garantia Estado; cashback 1,5%"},
...
function App(){
  ...
  return React.createElement(React.Fragment,null,
    React.createElement("div", {style: {fontFamily:"'Inter',system-ui,sans-serif",background:N,minHeight:"100vh",color:"#111827"}}, React.createElement("div", {style: {background:"linear-gradient(135deg,#ffffff 0%,#eff6ff 55%,#ffffff 100%)",borderBottom:"1px solid "+Au,padding:"10px 16px 0"}}, React.createElement("div", {style: {maxWidth:1440,margin:"0 auto"}}, React.createElement("div", {style: {display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexWrap:"wrap",gap:8,paddingBottom:10}}, React.createElement("div", null, React.createElement("a",{href:"/",style:{display:"flex",alignItems:"center",gap:8,textDecoration:"none",color:"inherit"}},React.createElement("svg",{width:26,height:26,viewBox:"0 0 24 24",fill:"none",stroke:"#2563eb",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",style:{flexShrink:0}},React.createElement("path",{d:"M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"}),React.createElement("polyline",{points:"9 22 9 12 15 12 15 22"})),React.createElement("h1",{style:{margin:0,fontSize:21,fontWeight:700,color:"#111827",letterSpacing:-0.3,fontFamily:"'Inter',system-ui,sans-serif"}},"Simulador Crédito Habitação")), React.createElement("div", {style: {fontSize:11,color:"#4b5563",fontFamily:"sans-serif",marginTop:2}}, "Portugal · 13 bancos · Euribor em tempo real"), React.createElement("div", {style:{display:"flex",gap:5,marginTop:7,flexWrap:"wrap"}}, ["3m","6m","12m"].map(k=>{const v=EUR[k]||FALLBACK_EUR[k];const[c,bg]=EUR_COLORS[k];return React.createElement("div",{key:k,style:{display:"flex",alignItems:"center",gap:5,padding:"3px 9px",background:bg,borderRight:"1px solid rgba(0,0,0,0.04)",borderRadius:4}},React.createElement("span",{style:{color:c,fontWeight:700,fontSize:10,fontFamily:"monospace",letterSpacing:1}},"EUR "+k.toUpperCase()),React.createElement("span",{style:{color:"#111827",fontSize:13,fontWeight:700,fontFamily:"monospace"}},v.valor.toFixed(3).replace(".",",")+"%"),v.data&&React.createElement("span",{style:{color:"#4b5563",fontSize:10,fontFamily:"sans-serif",marginLeft:2}},v.data));}),React.createElement("div",{style:{display:"flex",alignItems:"center",gap:4,marginLeft:6,paddingLeft:8,borderLeft:"1px solid rgba(0,0,0,0.08)",fontSize:11,color:stColor,fontFamily:"sans-serif"}},stIcon+" "+msg,ts&&status!=="loading"&&React.createElement("span",{style:{color:"#4b5563",marginLeft:3}},ts.toLocaleTimeString("pt-PT",{hour:"2-digit",minute:"2-digit"}))))), React.createElement("div", {style:{display:"flex",flexDirection:"column",gap:4,alignItems:"flex-end"}}, React.createElement("div", {style:{display:"flex",gap:5,alignItems:"center",flexWrap:"wrap"}},
            ...
            ))))), React.createElement("div", {style: {maxWidth:1440,margin:"0 auto",padding:"10px 14px"}}, React.createElement("div",{style:{display:"flex",borderRadius:9,overflow:"hidden",border:"1px solid rgba(0,0,0,0.07)",marginBottom:10}},React.createElement("button",{onClick:()=>{},style:{flex:1,padding:"9px",border:"none",background:"rgba(37,99,235,0.08)",borderBottom:"2px solid "+Au,color:Au,fontSize:13,fontFamily:"sans-serif",cursor:"default",fontWeight:600}},"🏠 Simulador"),React.createElement("button",{onClick:()=>setShowComments(c=>!c),style:{flex:1,padding:"9px",border:"none",background:showComments?"rgba(139,92,246,0.08)":"rgba(255,255,255,1)",borderBottom:"2px solid "+(showComments?"#7c3aed":"transparent"),color:showComments?"#7c3aed":"#4b5563",fontSize:13,fontFamily:"sans-serif",cursor:"pointer",fontWeight:600}},"💬 Comentários"+(commentTotal>0?" ("+commentTotal+")":"")),React.createElement("button",{onClick:()=>{window.location.href="/quanto-posso-pedir.html";},style:{flex:1,padding:"9px",border:"none",background:"rgba(255,255,255,1)",borderBottom:"2px solid transparent",color:G,fontSize:13,fontFamily:"sans-serif",cursor:"pointer",fontWeight:600}},"💰 Quanto Posso Pedir?"),React.createElement("button",{onClick:()=>{window.location.href="/historico.html";},style:{flex:1,padding:"9px",border:"none",background:"rgba(255,255,255,1)",borderBottom:"2px solid transparent",color:"#0284c7",fontSize:13,fontFamily:"sans-serif",cursor:"pointer",fontWeight:600}},"📈 Histórico")),React.createElement("div", {style: {display:"flex",borderRadius:9,overflow:"hidden",border:"1px solid rgba(0,0,0,0.07)",marginBottom:10}}, [{id:false,icon:"🏦",label:"Crédito Normal",c:Au},{id:true,icon:"🎓",label:"Crédito Jovem ≤35 anos",c:G}].map(({id,icon,label,c})=>(
