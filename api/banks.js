...
const SEED_BANKS = [
  ...
  { code: "ABANCA", name: "Abanca", color: "#00529b", refs: ["3m", "6m", "12m"], jOk: true, carenciaMax: 0, tipos: ["variável", "mista"], promos: ["Indexante Euribor 3m, 6m ou 12m", "Taxa fixa 2,70% 1.º/2.º ano"], prod: "Dom. ≥1.000€ + Seg. Vida + Multi + Cartão", jProd: "TAN fixa 2,70% 1.º ano → spread 0,70%" },
  ...
  { code: "MNTPO", name: "Banco Montepio", color: "#7a0f2e", refs: ["3m", "6m", "12m"], jOk: true, carenciaMax: 24, tipos: ["variável", "mista", "fixa"], promos: ["CH §18.1: Euribor 3/6/12m + spread 0,70–2,30% (mai.2026)", "Mista 2a: TAN 3,10% c/ prod.", "Taxa fixa: TAN ~4,50% c/ prod. / ~5,90% s/ prod.", "Cashback 1,5%"], prod: "Conta Ordenado + Cartão ≥500€/sem + Seg. Vida + Multirriscos Lusitania", jProd: "100% garantia Estado; taxa fixa disponível; cashback 1,5%" },
