...
// ── Seed data ─────────────────────────────────────────────────────────────
const SEED_BANKS = [
  { code: "CA", name: "Crédito Agrícola", color: "#2d6a2d", refs: ["12m"], jOk: true, carenciaMax: 0, tipos: ["variável", "mista", "fixa"], promos: ["CH CA Dedicado: spread 0,70–1,83% (Euribor 1/3/6/12m; PRE-FT mai.2026)", "Spread promocional 0,45% primeiros 24m (campanha)", "Taxa fixa ilustr. 4,70–5,83% (5/10/15a)"], prod: "Dom. ordenado + Seg. Vida CA + Multirriscos CA", jProd: "18–30a: isenção comissão abertura + manutenção DO nos exemplos TAEG (Nota 1e/1f)" },
  { code: "CTT", name: "Banco CTT", color: "#e30613", refs: ["12m"], jOk: true, carenciaMax: 0, tipos: ["variável", "mista"], promos: ["Spread CH 0,70–2,60% (precário §18.1)", "Pack domiciliação + seguros (spread reduzido)", "CH Sinal Jovem: TAN fixa 5%"], prod: "Seg. Vida + Multirriscos + Dom. CTT", jProd: "Mista 2a ilustr. 3,65% fixo; Sinal Jovem 5% fixo" },
