...
const SEED_BANKS = [
  ...
  { code: "CTT", name: "Banco CTT", color: "#e30613", refs: ["3m", "6m", "12m"], jOk: true, carenciaMax: 0, tipos: ["variável", "mista", "fixa"], promos: ["Spread CH 0,70–2,60% (precário §18.1)", "Mista 2a: TAN 2,70% c/ prod. / 3,30% s/ prod.", "Taxa fixa 30a: TAN 3,90% c/ prod. / 4,50% s/ prod.", "CH Sinal Jovem: TAN fixa 5%"], prod: "Seg. Vida + Multirriscos + Dom. CTT", jProd: "Mista 2a TAN 2,70% c/ prod.; taxa fixa 30a 3,90%; Sinal Jovem 5%" },
  ...
  { code: "UCI", name: "UCI", color: "#1a3a6b", refs: ["6m"], jOk: true, carenciaMax: 0, tipos: ["variável", "mista", "fixa"], promos: ["CH variável: E6 + spread 1,43–2,30% (§18.1 mai.2026)", "Mista: TAN 4,09% (5a) / 4,29% (10a fixo + E6)", "Taxa fixa 10a: TAN 4,39% (sem diferenciação c/s prod.)", "Montante 12,5k–1M€", "Sem conta obrigatória"], prod: "Seg. Vida + Multirriscos", jProd: "100% c/ garantia Estado (ver condições UCI)" },
...
const SEED_SPREADS = {
  ...
  CTT: { sCom: 0.70, sSem: 2.60, mCom: 2.70, mSem: 3.30, fCom: 3.90, fSem: 4.50, jsCom: 0.70, jsSem: 2.60, promoPeriodo: 0, promoSpread: null, dossier: 280, avaliacao: 230, contaMes: 1.73, contaNota: "20€/ano conta + IS 4% (exemplos TAEG precário mai.2026)", capMin: 25000, capMax: 1000000, vRef: 15.71, mAno: 170, insV: "CTT Seguros", insM: "CTT Seguros", minutas: 160, jovemIsenta: false },
