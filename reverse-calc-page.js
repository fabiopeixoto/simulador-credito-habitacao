...
function ReverseCalcPage({onBack,onSimulate,onOpenComments,commentCount,EUR}){
  ...
  return React.createElement("div",{style:{fontFamily:"'Inter',system-ui,sans-serif",background:N,minHeight:"100vh",color:"#111827"}},
    React.createElement("div",{style:{background:"linear-gradient(135deg,#ffffff 0%,#eff6ff 55%,#ffffff 100%)",borderBottom:"1px solid rgba(37,99,235,0.4)",padding:"10px 16px 0"}},
      React.createElement("div",{style:{maxWidth:1440,margin:"0 auto"}},
        React.createElement("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexWrap:"wrap",gap:8,paddingBottom:10}},
          React.createElement("div",null,
            React.createElement("a",{href:"/",style:{display:"flex",alignItems:"center",gap:8,textDecoration:"none",color:"inherit"}},React.createElement("svg",{width:26,height:26,viewBox:"0 0 24 24",fill:"none",stroke:"#2563eb",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",style:{flexShrink:0}},React.createElement("path",{d:"M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"}),React.createElement("polyline",{points:"9 22 9 12 15 12 15 22"})),React.createElement("h1",{style:{margin:0,fontSize:21,fontWeight:700,color:"#111827",letterSpacing:-0.3,fontFamily:"'Inter',system-ui,sans-serif"}},"Simulador Crédito Habitação")),
            React.createElement("div",{style:{fontSize:11,color:"#4b5563",fontFamily:"sans-serif",marginTop:2}},"Portugal · 13 bancos · Euribor em tempo real"),
            React.createElement("div",{style:{display:"flex",gap:5,marginTop:7,flexWrap:"wrap"}},["3m","6m","12m"].map(k=>{const v=EUR[k]||FALLBACK_EUR[k];const[ec,ebg]=EUR_COLORS[k];return React.createElement("div",{key:k,style:{display:"flex",alignItems:"center",gap:5,padding:"3px 9px",background:ebg,borderRight:"1px solid rgba(0,0,0,0.04)",borderRadius:4}},React.createElement("span",{style:{color:ec,fontWeight:700,fontSize:10,fontFamily:"monospace",letterSpacing:1}},"EUR "+k.toUpperCase()),React.createElement("span",{style:{color:"#111827",fontSize:13,fontWeight:700,fontFamily:"monospace"}},v.valor.toFixed(3).replace(".",",")+"%"),v.data&&React.createElement("span",{style:{color:"#4b5563",fontSize:10,fontFamily:"sans-serif",marginLeft:2}},v.data));}))
          )
        ),
        React.createElement("div",{style:{display:"flex",borderRadius:9,overflow:"hidden",border:"1px solid rgba(0,0,0,0.07)"}},React.createElement("button",{onClick:onBack,style:{flex:1,padding:"9px",border:"none",background:"rgba(255,255,255,1)",borderBottom:"2px solid transparent",color:"#4b5563",fontSize:13,fontFamily:"sans-serif",cursor:"pointer",fontWeight:600}},"🏠 Simulador"),React.createElement("button",{onClick:onOpenComments,style:{flex:1,padding:"9px",border:"none",background:"rgba(255,255,255,1)",borderBottom:"2px solid transparent",color:"#4b5563",fontSize:13,fontFamily:"sans-serif",cursor:"pointer",fontWeight:600}},"💬 Comentários"+(commentCount>0?" ("+commentCount+")":"")),React.createElement("button",{style:{flex:1,padding:"9px",border:"none",background:"rgba(37,99,235,0.08)",borderBottom:"2px solid "+Au,color:Au,fontSize:13,fontFamily:"sans-serif",cursor:"default",fontWeight:600}},"💰 Quanto Posso Pedir?"),React.createElement("button",{onClick:function(){window.location.href="/historico.html";},style:{flex:1,padding:"9px",border:"none",background:"rgba(255,255,255,1)",borderBottom:"2px solid transparent",color:Sky,fontSize:13,fontFamily:"sans-serif",cursor:"pointer",fontWeight:600}},"📈 Histórico")),
        React.createElement("div",{style:{fontSize:11,color:"#4b5563",paddingBottom:10}},"Descobre o capital máximo que podes pedir com base na tua capacidade financeira · Indicativo")
      )
    ),
