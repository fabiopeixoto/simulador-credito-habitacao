...
function ReverseCalcPage({onBack,onSimulate,EUR}){
  ...
  return React.createElement("div",{style:{fontFamily:"'Inter',system-ui,sans-serif",background:N,minHeight:"100vh",color:"#111827"}},
    React.createElement("div",{style:{background:"linear-gradient(135deg,#ffffff 0%,#f0fdf4 55%,#ffffff 100%)",borderBottom:"1px solid rgba(22,163,74,0.4)",padding:"10px 16px"}},
      React.createElement("div",{style:{maxWidth:1000,margin:"0 auto",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:10}},
        React.createElement("div",null,
          React.createElement("div",{style:{display:"flex",borderRadius:9,overflow:"hidden",border:"1px solid rgba(0,0,0,0.07)",marginBottom:6}},React.createElement("button",{onClick:onBack,style:{flex:1,padding:"9px",border:"none",background:"rgba(255,255,255,1)",borderBottom:"2px solid transparent",color:"#4b5563",fontSize:13,fontFamily:"sans-serif",cursor:"pointer",fontWeight:600}},"🏠 Simulador"),React.createElement("button",{disabled:true,style:{flex:1,padding:"9px",border:"none",background:"rgba(255,255,255,1)",borderBottom:"2px solid transparent",color:"#9ca3af",fontSize:13,fontFamily:"sans-serif",cursor:"default",fontWeight:400}},"💬 Comentários"),React.createElement("button",{style:{flex:1,padding:"9px",border:"none",background:"rgba(22,163,74,0.08)",borderBottom:"2px solid "+G,color:G,fontSize:13,fontFamily:"sans-serif",cursor:"default",fontWeight:600}},"🔄 Calculadora Inversa")),
    ...
    React.createElement("div",{style:{maxWidth:1000,margin:"0 auto",padding:"12px 14px"}},
      ...
      capMax>0&&React.createElement("div",{style:{background:"rgba(37,99,235,0.06)",border:"1px solid rgba(37,99,235,0.2)",borderRadius:9,padding:"12px 14px",marginBottom:14,display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:8}},
        ...
        React.createElement("button",{onClick:()=>onSimulate(capMax,mJ,jovemLTV),style:{padding:"9px 18px",background:Au,border:"none",borderRadius:8,color:"#ffffff",fontSize:13,fontWeight:700,cursor:"pointer",fontFamily:"sans-serif",whiteSpace:"nowrap"}},"Abrir Simulador →")
      ),
